...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------#
    save_dir = 'logs/LYC_third_filter_416/'
    # ------------------------------------------------------------------#
    ...
    # ------------------------------------------------------#
    train_annotation_path = 'E:/postgraduate_data/detection/LYC_third_filter_ImageSets/LYC_third_filter_train.txt'
    val_annotation_path = 'E:/postgraduate_data/detection/LYC_third_filter_ImageSets/LYC_third_filter_val.txt'
    ...
    if ngpus_per_node > 1:
        with strategy.scope():
            ...
            model = get_train_model(model_body, input_shape, num_classes, anchors, anchors_mask, label_smoothing,
                                    focal_loss, focal_alpha, focal_gamma, iou_type)
    else:
        # ------------------------------------------------------#
        #   创建yolo模型
        # ------------------------------------------------------#
    ...
    if True:
        ...
        if eager:
            ...
            for epoch in range(start_epoch, end_epoch):
                ...
                fit_one_epoch(model, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen,
                              gen_val, end_epoch, save_period, save_dir, strategy)
